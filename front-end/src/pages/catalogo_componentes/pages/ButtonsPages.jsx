...
export default function ButtonsPage({ datos, filtro, favoritos, toggleFav }) {
  ...
  // Filtrado de datos (Categoría Buttons + Buscador)
  ...
  return (
    <>
      ...
      <title>Botones | El Rincón del Front-end</title>
      ...
      <div className="w-[95%] max-w-[1300px] mx-auto pt-[100px] pb-[50px] grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] justify-center gap-[40px] cursor-[url('/cursor.svg')_16_16,_auto] [&_input]:cursor-[url('/pointer.svg')_16_16,_text]">
        ...
        {buttonsFiltrados.length === 0 && <p className="text-[var(--text-primary)] text-center w-full">No se encontraron botones con ese nombre.</p>}
      </div>
    </>
  );
}
