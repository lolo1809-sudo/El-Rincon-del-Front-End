...
export default function ModalesPage({ datos, filtro, favoritos, toggleFav }) {
  ...
  // Filtrado de datos (Categoría Modales + Buscador)
  ...
  return (
    <>
      ...
      <title>Modales | El Rincón del Front-end</title>
      ...
      <div className="w-[95%] max-w-[1300px] mx-auto pt-[100px] pb-[50px] grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] justify-center gap-[40px] cursor-[url('/cursor.svg')_16_16,_auto] [&_input]:cursor-[url('/pointer.svg')_16_16,_text]">
        ...
        {modalesFiltrados.length === 0 && <p className="text-[var(--text-primary)] text-center w-full">No se encontraron modales con ese nombre.</p>}
      </div>
    </>
  );
}
