...
export default function JuegosPage({ datos, filtro, favoritos, toggleFav }) {
  ...
  // Filtrado de datos (Categoría Juegos + Buscador)
  ...
  return (
    <>
      ...
      <title>Juegos | El Rincón del Front-end</title>
      <meta name="description" content="Colección de los mejores juegos hechos con HTML, CSS, JS, listos para jugar" />
      ...
      <div className="w-[95%] max-w-[1300px] mx-auto pt-[100px] pb-[50px] grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] justify-center gap-[40px] cursor-[url('/cursor.svg')_16_16,_auto] [&_input]:cursor-[url('/pointer.svg')_16_16,_text]">
        ...
        {juegosFiltrados.length === 0 && <p className="text-[var(--text-primary)] text-center w-full">No se encontraron juegos con ese nombre.</p>}
      </div>
    </>
  );
}
